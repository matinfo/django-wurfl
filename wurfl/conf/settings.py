...
UA_INTERNAL_MATCHING = getattr(settings, 'WURFL_UA_INTERNAL_MATCHING', False)
UA_INTERNAL_MATCHING_MAX_DISTANCE = getattr(settings, 'WURFL_UA_INTERNAL_MATCHING_MAX_DISTANCE', 30)
UA_INTERNAL_MATCHING_LIMIT = getattr(settings, 'WURFL_UA_INTERNAL_MATCHING_LIMIT', 10)
